...
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 9 & chmatch(LINE_ICD_DGNS_CD, arthritis_icd_9_codes), is_arthritis:=T]
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 0 & chmatch(LINE_ICD_DGNS_CD, arthritis_icd_10_codes), is_arthritis:=T]

carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 9 & chmatch(LINE_ICD_DGNS_CD, hypertension_icd_9_codes), is_hypertension:=T]
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 0 & chmatch(LINE_ICD_DGNS_CD, hypertension_icd_10_codes), is_hypertension:=T]

carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 9 & chmatch(LINE_ICD_DGNS_CD, IHD_icd_9_codes), is_IHD:=T]
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 0 & chmatch(LINE_ICD_DGNS_CD, IHD_icd_10_codes), is_IHD:=T]

carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 9 & chmatch(LINE_ICD_DGNS_CD, diabetes_icd_9_codes), is_diabetes:=T]
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 0 & chmatch(LINE_ICD_DGNS_CD, diabetes_icd_10_codes), is_diabetes:=T]

carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 9 & chmatch(LINE_ICD_DGNS_CD, depression_icd_9_codes), is_depression:=T]
carrier_data_all_years[LINE_ICD_DGNS_VRSN_CD == 0 & chmatch(LINE_ICD_DGNS_CD, depression_icd_10_codes), is_depression:=T]
...
yearly_patient_conditions_carrier=carrier_data_all_years
...
write.fst(summary_with_physician_integration_stats,"calculation_results_new_new.fst")
